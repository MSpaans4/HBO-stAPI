...
namespace PoohAPI.Logic.Common.Interfaces
{
    public interface IReviewCommandService
    {
        ...
        DateTime creationDate, int verifiedReview, int verifiedBy, bool isReview);
        void DeleteReview(int id);
        Review PostReview(int companyId, int userId, int stars, string writtenReview, int anonymous, bool isReview);
    }
}
